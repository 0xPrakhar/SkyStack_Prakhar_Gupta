    ...
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden bg-black px-4">
      ...
      >
        ...
        <div className="w-full flex items-center gap-4 my-8 opacity-50">
          ...
          <span className="text-xs uppercase font-bold text-slate-400">Or</span>
          <div className="h-px bg-white/20 flex-1" />
        </div>

        <button className="w-full flex items-center justify-center gap-3 py-4 bg-white/5 hover:bg-white/10 border border-white/20 rounded-2xl text-white font-bold transition-colors">
